...
import { FaMoon, FaLinkedin, FaGithub, FaHtml5, FaCss3Alt, FaJs, FaReact } from 'react-icons/fa'
    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="w-full min-h-screen bg-zinc-200 dark:bg-zinc-900 text-black dark:text-white px-5 lg:px-10">
        ...
        <section className='h-screen w-full flex flex-col'>
          ...
          <div className='flex-grow flex flex-col justify-center items-center text-center p-5 lg:p-10'>
            ...
            <p className='w-full lg:w-1/2 lg:mx-auto text-sm lg:text-md py-5 text-zinc-500 lg:leading-9'>
              Enthusiastic fresher with a solid foundation in C++ and hands-on experience
            ...
            <div className='text-4xl lg:text-5xl flex justify-center gap-16 py-4'>
              <a href="https://www.linkedin.com/in/ganisha-verma-906341251" target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
              <a href="https://github.com/Ganishaverma19" target='_blank' rel='noopener noreferrer'><FaGithub /></a>
            ...
            <div className='flex justify-center py-4'>
              <img src={img} alt="Avatar" className="w-40 h-40 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full" />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className='flex justify-center text-5xl gap-6 my-4'>
